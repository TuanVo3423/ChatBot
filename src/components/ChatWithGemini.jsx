...
const Introduction = () => {
  ...
  return (
    <Box className="flex flex-col items-center justify-center">
      <Box className="flex flex-col items-center justify-center">
        <TextRenderer value="Welcome to HuuDai's BotChat AI" size="xxx-large" />
        <TextRenderer
          value="I'm Dai, a chatbot that can help you with your queries"
          direction={"l"}
        />
      </Box>
      <Box className="flex flex-col items-center justify-center">
  ...
  return parts.map((part, index) =>
    part.text ? (
      <>
        <Box
          as={motion.div}
          className={`flex overflow-auto max-w-[95%]  md:max-w-[96%] w-fit items-end my-2 p-1 px-2 rounded-md ${
